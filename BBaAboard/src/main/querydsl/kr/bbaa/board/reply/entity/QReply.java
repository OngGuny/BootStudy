...
public class QReply extends EntityPathBase<Reply> {
    ...
    private static final long serialVersionUID = -1402467054L;
    ...
    public QReply(Class<? extends Reply> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new kr.bbaa.member.entity.QMember(forProperty("member")) : null;
    }
