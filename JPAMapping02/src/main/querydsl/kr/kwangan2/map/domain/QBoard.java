...
public class QBoard extends EntityPathBase<Board> {
    ...
    private static final long serialVersionUID = 402103742L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBoard board = new QBoard("board");

    public final ListPath<Attach, QAttach> attachList = this.<Attach, QAttach>createList("attachList", Attach.class, QAttach.class, PathInits.DIRECT2);
